...
import { Ticket, Clock, Users, Activity, Search, CalendarIcon, X, Sun, Moon } from "lucide-react";
...
const Index = () => {
  ...
  const { notifications, unreadCount, markAllRead, markAsRead, clearAll } = useTicketNotifications();
